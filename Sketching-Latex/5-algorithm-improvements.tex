...
Because of finite sample noise and the random nature of the projections, these estimated subspaces $\bm{U}_s^{(l)}$ differ slightly but significantly across directions. Consequently, the Rotational Invariance Matrices $\bm{\Psi}_l$ are defined in different bases (different coordinate systems).
